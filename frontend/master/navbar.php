        <div class="min-h-full">
                    ...
                    <div class="flex h-14 items-center justify-between">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <div class="p-2 h-10 w-10 bg-gray-800 rounded-full text-white flex justify-center items-center text-xl font-bold">OP</div>
                            </div>
            ...
            <header class="bg-white shadow">
                <div class="mx-auto max-w-7xl py-2 px-4 sm:px-6 lg:px-8">
                    <h1 class="text-xl font-bold tracking-tight text-gray-900"><?php echo $page_title?></h1>
                </div>
            </header>
        </div>